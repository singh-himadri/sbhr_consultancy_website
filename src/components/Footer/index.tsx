      ...
      <div className={`container ${styles.grid}`}>
        ...
        <div className={styles.brandCol}>
          ...
          <div className={styles.socials}>
            <a href="https://www.linkedin.com/company/sb-hr-consultancy-pvt-ltd/" className={styles.socialIcon} aria-label="LinkedIn" id="footer-social-linkedin">
        ...
        <div className={styles.linkCol}>
          ...
          <ul className={styles.contactInfo}>
            ...
            <li className={styles.contactItem}>
              ...
              <a href="mailto:hr@sbhrconsultancy.in" className={styles.link} id="footer-email-link">
            ...
            <li className={styles.contactItem}>
              ...
              <a href="tel:+919433125399" className={styles.link} id="footer-phone-link">
                +91 9433125399
              </a>
            </li>
          </ul>
