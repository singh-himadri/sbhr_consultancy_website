...
const SERVICES = [
  ...
  {
    id: "card-pan-india-workforce",
    linkId: "link-pan-india-workforce-details",
    href: "/services/pan-india-workforce",
    tag: "05",
    title: "Pan-India Workforce & Employment",
    desc: "Expand across India with ease — we manage employment compliance, payroll, and multi-state workforce administration so you can focus on growth.",
    icon: (
      <>
        <circle cx="12" cy="12" r="10" />
